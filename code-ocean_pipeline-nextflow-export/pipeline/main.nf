...
// hash:sha256:a8262dd3f323eb08904f869b4fa4f283a5be1e087ffc28c386ccc61a5726ba13
...
process capsule_mapreduce_process_synapses_table_generate_config_28 {
	...
	git -C capsule-repo checkout d609470dd9aa661c844a36c04ca59348b8e2d68f --quiet
...
process capsule_mapreduce_process_synapses_table_generate_id_index_config_31 {
	...
	git -C capsule-repo checkout dbd968180583e5ce925fc62147bd4ebd6a369ec8 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_generate_input_split_ranges_and_worker_ids_5 {
	...
	git -C capsule-repo checkout 99b1f1733123bf7a49576d4ade79c12681decde4 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_generate_relation_index_config_32 {
	...
	git -C capsule-repo checkout 0388dd48baf6c6670aaea8af89b2d8dc7ef941f2 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_generate_spatial_index_config_33 {
	...
	git -C capsule-repo checkout a69dd1fbd405d0b6f6f452aedca78fca2cd0ad59 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_generate_input_split_6 {
	...
	ln -s "/tmp/data/data_asset_name" "capsule/data/data_asset_name" # id: bacb8982-892d-437b-b732-de1257e7a398
	...
	git -C capsule-repo checkout af267c2cd6f85197ce5910bcba005228546d421e --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_generate_shard_worker_ids_30 {
	...
	git -C capsule-repo checkout 39f879e472fae2afe76bbdbbfe3df121256df690 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_build_id_index_19 {
	...
	git -C capsule-repo checkout ed3c3ac66f8cc6fe8ecd3639e108070496b2909c --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_build_relation_index_24 {
	tag 'capsule-8542974'
	container "registry.codeocean.allenneuraldynamics.org/capsule/f6fde948-5201-4c3c-87fa-b1e7d5fee472:5ed5f71527f072bc48fe7046ac9057db"
	...
	git -C capsule-repo checkout ce8d3e9ffe01ef9c9094887aa326cb27f22bd360 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_build_spatial_index_oct_tree_44 {
	...
	git -C capsule-repo checkout 00b7ec0f60a6758428050fc8f2afa68e74cc501a --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_conglomerate_id_index_by_shard_22 {
	...
	git -C capsule-repo checkout 8717dfa48ced0a61ff233dea330ba8ecff7589f8 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_conglomerate_relation_index_by_shard_23 {
	...
	git -C capsule-repo checkout 9940c032026ceddec222f38f5ccaa24f1f34b73d --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_regroup_worker_outputs_18 {
	...
	git -C capsule-repo checkout cc8cc27cc0a46a14092a91e90bd01faea5834482 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
...
process capsule_mapreduce_process_synapses_table_reorganize_directory_structure_27 {
	...
	git -C capsule-repo checkout a24dffd1e0db358bd7bad8270324d49b407a1955 --quiet
	mv capsule-repo/code capsule/code && ln -s \$PWD/capsule/code /code
	rm -rf capsule-repo
